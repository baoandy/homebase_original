...
export default function Footer() {
  return (
    <div className="flex flex-col items-center px-4 lg:px-20 pt-12 pb-6 mt-40 bg-zinc-800 rounded-[32px] mx-auto w-full">
      <div className="self-stretch mt-3 mr-6 ml-6  max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-[22%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-center grow text-base leading-6 text-sky-100 whitespace-nowrap max-md:mt-10">
              ...
              <div className="icon-container my-5 flex flex-row items-center justify-start gap-3 ">
                ...
                >
                  <div className="border rounded-full w-8 h-8 flex items-center justify-center hover:bg-[#366871] ">
          ...
          <div className="flex flex-col ml-5 w-[78%] max-md:ml-0 max-md:w-full">
            <div className="flex grow gap-5 justify-between items-start pr-9 mt-2.5 text-sm leading-5 text-stone-50 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
      ...
      <div className="mt-24 text-sm leading-5 text-center text-white">
