                          ...
                          <div className="text-center">
                            ...
                            <div className="mb-4 flex items-center">
                              <div className="relative flex-grow">
                                ...
                                />
                                <button
                                  className="absolute bottom-0 right-0 top-0 rounded-r-md bg-primary px-4 text-white transition duration-200 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  onClick={() => {
